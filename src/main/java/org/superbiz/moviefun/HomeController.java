...
//
    ...
    public HomeController(MoviesBean moviesBean,
        ...
        transactionTemplateAlbums = new TransactionTemplate(platformTransactionManagerAlbums);
        transactionTemplateMovies = new TransactionTemplate(platformTransactionManagerMovies);
    }
    ...
    public String setup(Map<String, Object> model) {
        for (Movie movie : movieFixtures.load()) {
            transactionTemplateMovies.execute(status -> {
        ...
        for (Album album : albumFixtures.load()) {
            transactionTemplateAlbums.execute(status -> {
